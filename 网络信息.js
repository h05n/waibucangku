...
// 本地: myip.ipip.net (国内定位最准) + ip-api.com (ASN补充) 并行极速查询
// 入口: ip-api.com lang=zh-CN (国内精准中文化) → ip.sb 兜底
// 落地: ip.sb (全球BGP最准) → ipinfo.io 兜底
...
!(async () => {
  ...
  const RETRIES        = 2
  const RETRY_DELAY    = 800 // 稍微缩短重试延迟，提升整体响应速度
  ...
  const GEOS = {
    ...
    Guancheng:'管城', Zhongyuan:'中原', Erqi:'二七', Jinshui:'金水', Huiji:'惠济', Xinzheng:'新郑',
    Huangpu:'黄浦', Xuhui:'徐汇', Changning:'长宁', Putuo:'普陀', Hongkou:'虹口', Yangpu:'杨浦',
    Minhang:'闵行', Baoshan:'宝山', Jiading:'嘉定', Pudong:'浦东', Jinshan:'金山', Songjiang:'松江',
    Qingpu:'青浦', Fengxian:'奉贤', Chongming:'崇明',
    Haidian:'海淀', Chaoyang:'朝阳', Dongcheng:'东城', Xicheng:'西城', Fengtai:'丰台', Shijingshan:'石景山',
    Tongzhou:'通州', Changping:'昌平', Daxing:'大兴', Huairou:'怀柔', Pinggu:'平谷', Miyun:'密云', Yanqing:'延庆',
    Haizhu:'海珠', Tianhe:'天河', Yuexiu:'越秀', Liwan:'荔湾', Panyu:'番禺', Nansha:'南沙',
    Zengcheng:'增城', Conghua:'从化', Baiyun:'白云',
    Nanshan:'南山', Futian:'福田', Luohu:'罗湖', Baoan:'宝安', Longhua:'龙华', Longgang:'龙岗',
    Yantian:'盐田', Pingshan:'坪山', Guangming:'光明',
    'Central and Western':'中西区', Eastern:'东区', Southern:'南区', 'Wan Chai':'湾仔', 'Sham Shui Po':'深水埗',
    'Kowloon City':'九龙城', 'Kwun Tong':'观塘', 'Wong Tai Sin':'黄大仙', 'Yau Tsim Mong':'油尖旺',
    'Kwai Tsing':'葵青', 'Tsuen Wan':'荃湾', 'Tuen Mun':'屯门', 'Yuen Long':'元朗', 'Tai Po':'大埔', 'Sha Tin':'沙田',
    'Sai Kung':'西贡', Islands:'离岛', 'Kwai Chung':'葵涌', Kowloon:'九龙', 'Hong Kong':'香港',
    Taipei:'台北', 'New Taipei':'新北', Taoyuan:'桃园', Taichung:'台中', Tainan:'台南', Kaohsiung:'高雄', Hsinchu:'新竹',
    Tokyo:'东京', Osaka:'大阪', Kanagawa:'神奈川', Aichi:'爱知', Saitama:'埼玉', Chiba:'千叶',
    Hyogo:'兵库', Hokkaido:'北海道', Fukuoka:'福冈', Shizuoka:'静冈', Ibaraki:'茨城', Hiroshima:'广岛',
    Kyoto:'京都', Miyagi:'宫城', Niigata:'新潟', Nagano:'长野', Gifu:'岐阜', Tochigi:'栃木',
    Gunma:'群马', Okayama:'冈山', Mie:'三重', Kumamoto:'熊本', Kagoshima:'鹿儿岛', Oita:'大分',
    Yamaguchi:'山口', Shiga:'滋贺', Ehime:'爱媛', Nara:'奈良', Nagasaki:'长崎', Miyazaki:'宫崎',
    Aomori:'青森', Iwate:'岩手', Akita:'秋田', Yamagata:'山形', Fukushima:'福岛', Ishikawa:'石川',
    Toyama:'富山', Fukui:'福井', Yamanashi:'山梨', Wakayama:'和歌山', Tottori:'鸟取', Shimane:'岛根',
    Tokushima:'德岛', Kagawa:'香川', Kochi:'高知', Okinawa:'冲绳', Saga:'佐贺',
    Yokohama:'横滨', Nagoya:'名古屋', Sapporo:'札幌', Kobe:'神户',
    Seoul:'首尔', Busan:'釜山', Incheon:'仁川', Daegu:'大邱', Daejeon:'大田', Gwangju:'光州', Ulsan:'蔚山',
    Gyeonggi:'京畿', Gangwon:'江原', Jeju:'济州', 'North Gyeongsang':'庆北', 'South Gyeongsang':'庆南',
    'North Jeolla':'全北', 'South Jeolla':'全南',
    California:'加利福尼亚', Washington:'华盛顿', Texas:'德克萨斯', Florida:'佛罗里达', Illinois:'伊利诺伊', Virginia:'弗吉尼亚',
    Massachusetts:'马萨诸塞', Georgia:'佐治亚', Ohio:'俄亥俄', Michigan:'密歇根', Pennsylvania:'宾夕法尼亚', Arizona:'亚利桑那',
    Nevada:'内华达', Colorado:'科罗拉多', Oregon:'俄勒冈', Missouri:'密苏里', Tennessee:'田纳西', Minnesota:'明尼苏达',
    'New York':'纽约', 'New Jersey':'新泽西', 'North Carolina':'北卡罗来纳', 'South Carolina':'南卡罗来纳',
    'District of Columbia':'华盛顿特区',
    'Los Angeles':'洛杉矶', 'San Francisco':'旧金山', 'San Jose':'圣何塞', Chicago:'芝加哥', Dallas:'达拉斯',
    Seattle:'西雅图', Atlanta:'亚特兰大', Miami:'迈阿密', Houston:'休斯顿', Phoenix:'凤凰城', Boston:'波士顿',
    Denver:'丹佛', Ashburn:'阿什本', Newark:'纽瓦克',
    Toronto:'多伦多', Vancouver:'温哥华', Montreal:'蒙特利尔',
    London:'伦敦', Frankfurt:'法兰克福', Amsterdam:'阿姆斯特丹', Paris:'巴黎', Madrid:'马德里', Zurich:'苏黎世', Vienna:'维也纳',
    Stockholm:'斯德哥尔摩', Copenhagen:'哥本哈根', Helsinki:'赫尔辛基', Oslo:'奥斯陆', Warsaw:'华沙',
    Prague:'布拉格', Budapest:'布达佩斯', Lisbon:'里斯本', Dublin:'都柏林', Moscow:'莫斯科', Istanbul:'伊斯坦布尔',
    Berlin:'柏林', Munich:'慕尼黑',
    Singapore:'新加坡', Bangkok:'曼谷', 'Kuala Lumpur':'吉隆坡', Jakarta:'雅加达', Manila:'马尼拉', 'Ho Chi Minh':'胡志明',
    Hanoi:'河内', Sydney:'悉尼', Melbourne:'墨尔本', Mumbai:'孟买', Dubai:'迪拜', Cairo:'开罗',
  }
  ...
  const ISP_MAP = [
    // 优先匹配港台特殊/知名供应商
    ['Netvigator', '网上行'], ['HKT', '香港电讯'], ['Hong Kong Telecommunications', '香港电讯'],
    ['PCCW', '电讯盈科'], ['HGC', '香港宽频国际'], ['HKBN', '香港宽频'],
    ['Chunghwa', '中华电信'], ['Taiwan Mobile', '台湾大哥大'], ['FarEasTone', '远传电信'],
    // 大陆供应商
    ['CHINA169', '中国联通'], ['CNC CHINA169', '中国联通'], ['CNC', '中国联通'], ['China Unicom', '中国联通'], ['CNCGROUP', '中国联通'],
    ['CHINANET', '中国电信'], ['China Telecom', '中国电信'],
    ['China Mobile', '中国移动'], ['CMNET', '中国移动'],
    ['China Broadnet', '中国广电'], ['China Tietong', '铁通'], ['CERNET', '教育网'],
    ['Alibaba', '阿里云'], ['Aliyun', '阿里云'], ['Tencent', '腾讯云'], ['Huawei Cloud', '华为云'],
    ['Baidu', '百度云'], ['UCloud', 'UCloud'], ['21Vianet', '世纪互联'], ['GDS', '万国数据'],
    ['Zhipinshang', '智品尚'],
    // 日韩/亚太其余
    ['NTT', 'NTT'], ['KDDI', 'KDDI'], ['SoftBank', '软银'], ['IIJ', 'IIJ'], ['ARTERIA', 'ARTERIA'], ['OCN', 'OCN'],
    ['SK Telecom', 'SKT'], ['KT Corp', 'KT'], ['LG Uplus', 'LG U+'],
    ['Singtel', '新电信'], ['StarHub', 'StarHub'], ['Telstra', 'Telstra'], ['Optus', 'Optus'],
    // 欧美大厂与云服务商
    ['Comcast', 'Comcast'], ['AT&T', 'AT&T'], ['Verizon', 'Verizon'], ['T-Mobile', 'T-Mobile'],
    ['Level 3', 'Level3'], ['Lumen', 'Lumen'],
    ['Amazon', 'AWS'], ['AMAZON', 'AWS'], ['Google', 'Google'], ['Microsoft', '微软'],
    ['Cloudflare', 'Cloudflare'], ['Fastly', 'Fastly'], ['Akamai', 'Akamai'], 
    ['Vultr', 'Vultr'], ['DigitalOcean', 'DO'], ['Linode', 'Linode'], ['Hetzner', 'Hetzner'], 
    ['OVH', 'OVH'], ['Contabo', 'Contabo'], ['Leaseweb', 'Leaseweb'],
    ['Cogent', 'Cogent'], ['Zayo', 'Zayo'], ['Hurricane Electric', 'HE.net'], ['Quadrant', 'Quadrant'],
    ['Misaka', 'Misaka'], ['DMIT', 'DMIT'], ['Zenlayer', 'Zenlayer'], ['Datacamp', 'Datacamp'],
    ['Deutsche Telekom', '德国电信'], ['Orange', 'Orange'], ['Vodafone', '沃达丰'], 
    ['KPN', 'KPN'], ['Swisscom', 'Swisscom'], ['BT Group', 'BT'],
  ...
  function formatISP(raw = '') {
    ...
    for (const [key, val] of ISP_MAP) {
      if (cleaned.toLowerCase().includes(key.toLowerCase()) || s.toLowerCase().includes(key.toLowerCase())) {
        return t2s(val)
      }
    }
  ...
  // 1. 本地查询：IPIP (国内定位极准) + ip-api (带ASN，解析快) 强强联合并发
  async function queryLocal() {
    const [ipipRaw, ipapiRaw] = await Promise.all([
      fetchJSON('https://myip.ipip.net/json', { policy: 'DIRECT' }, TIMEOUT_DIRECT).catch(() => null),
      fetchJSON('http://ip-api.com/json/?lang=zh-CN&fields=status,query,countryCode,regionName,city,isp,as', { policy: 'DIRECT' }, TIMEOUT_DIRECT).catch(() => null),
    ])
    ...
    return {
      ip: ipip?.ip || ipapi?.ip || '',
      // 地理位置优先使用 ipip 的极准数据，ip-api 兜底
      location: ipip?.location || ipapi?.location || '',
      // 运营商同理，ASN只能依靠 ip-api 补充
      isp: ipip?.isp || ipapi?.isp || '',
      asn: ipapi?.asn || '',
    }
  }

  // 2. 落地查询：ip.sb (全网 BGP ASN 极准) -> ipinfo.io 兜底
  ...
  // 3. 入口查询：ip-api.com (国内高精准且自带纯中文) -> ip.sb 兜底
  ...
  const entrance = entranceIP
    ? await queryEntrance(entranceIP).catch(() => null)
    : null
